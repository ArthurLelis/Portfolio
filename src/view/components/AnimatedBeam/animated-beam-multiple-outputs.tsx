...
import { AnimatedBeam } from "@/view/components/AnimatedBeam/animated-beam"
...
export default function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn("relative flex w-full items-center justify-center overflow-hidden right-0 transform translate-x-20", className)}
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-1">
