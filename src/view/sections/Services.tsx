  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute right-1/4 w-1 bg-gradient-to-b from-[#3b82f6]/0 via-[#8b5cf6]/80 to-[#3b82f6]/0"
      />
      ...
      <div className="p-14">
        <div className="space-y-4 max-w-1/2">
          ...
          <h1 className="text-[64px] text-[#111111cc] font-semibold tracking-[-1.4px] leading-none">
          ...
          <p className="text-lg text-[#111111cc] tracking-[-0.18px] leading-[160%]">
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-10">
          {services.map((service, index) => (
            <div
              key={index}
              className="p-6 rounded-lg hover:shadow-lg transition relative border-1 border-gray-300 border-l-4 border-l-[#3b82f6] bg-white"
            >
              <div className="flex items-center gap-6">
                ...
                <h3 className="text-[28px] font-semibold text-[#111111cc] tracking-[-0.864px] leading-[40.32px]">
                  {service.title}
                </h3>
              </div>
